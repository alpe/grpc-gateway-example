...
func request_Greeter_SayHello_0(ctx context.Context, client GreeterClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterGreeterHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("POST", pattern_Greeter_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Greeter_SayHello_0(runtime.AnnotateContext(ctx, req), client, req, pathParams)
		...
		forward_Greeter_SayHello_0(ctx, w, req, resp, mux.GetForwardResponseOptions()...)
